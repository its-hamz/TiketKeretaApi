                ...
                <form onSubmit={e => handleSubmit(e)}>
                    ...
                    <div className=" w-full p-3">
                        ...
                        <div className=" my-2 border rounded-md p-3">
                            ...
                            <input type="text" id={"descriptios"} value={descriptions} onChange={(e) => setDescriptions(e.target.value)} required={true} className=" p-1 outline-none focus:border-b-sky-600 focus:border-b w-full" />
                        </div>
                        <div className=" my-2 border rounded-md p-3">
                            <small className=" text-sm font-semibold text-sky-600">
                                Tipe Kereta
                            </small>
                            <input type="text" id={"type"} value={type} onChange={(e) => setType(e.target.value)} required={true} className=" p-1 outline-none focus:border-b-sky-600 focus:border-b w-full" />
                        </div>
