        ...
        <div className=" w-dvw">
            ...
            <div className={` w-1/2 md:w-1/3 lg:w-1/4 bg-orange-500 h-dvh fixed top-0 transform transition-transform ${show ? `left-0` : `right-full`}`}>
                ...
                <div className=" w-full flex flex-col">
                    <Link href={"/customer/jadwal"} className=" w-full rounded-md text-white p-3 font-semibold hover:bg-orange-400">
                        Cari Jadwal Kereta
                    </Link>
                    <Link href={"/customer/history"} className=" w-full rounded-md text-white p-3 font-semibold hover:bg-orange-400">
                        History
                    </Link>
